...
public class NetBeansJavaClassObjectAnnotationArgument implements JavaClassObjectAnnotationArgument {
    ...
    public JavaType getReferencedType() {
        TypeMirrorHandle handle = NBElementUtils.getTypeMirrorHandleFromFQName(new FqName(javaClass.getCanonicalName()), kotlinProject);
        return NetBeansJavaType.create(handle, kotlinProject);
    }
