...
public class NetBeansJavaReferenceAnnotationArgument extends NetBeansJavaAnnotationArgument 
    ...
    public NetBeansJavaReferenceAnnotationArgument(FqName fqName, Project project, ElementHandle handle) {
    ...
    public JavaField resolve() {
        return new NetBeansJavaField(getFqName(), getProject(), NBElementUtils.getJavaClassOfMember(handle, getProject()));
    }
