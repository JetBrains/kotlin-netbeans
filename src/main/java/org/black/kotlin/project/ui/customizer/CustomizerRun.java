...
public class CustomizerRun extends JPanel implements HelpCtx.Provider {
    ...
    KotlinProjectProperties uiProperties;
    
    private KotlinRunConfigProvider compProvider;
    
    public CustomizerRun(KotlinProjectProperties uiProperties ) {
        this.uiProperties = uiProperties;
        initComponents();
        
        this.project = uiProperties.getProject();
        
        compProvider = Lookup.getDefault().lookup(KotlinRunConfigProvider.class);
        ...
        keys = new String[] {
            KotlinProjectProperties.MAIN_CLASS,
            KotlinProjectProperties.APPLICATION_ARGS,
            KotlinProjectProperties.RUN_JVM_ARGS,
            KotlinProjectProperties.RUN_WORK_DIR,
        };
    ...
    private void initExtPanel(Project p) {
        if (compProvider != null) {
            KotlinRunConfigProvider.ConfigChangeListener ccl = new KotlinRunConfigProvider.ConfigChangeListener() {
