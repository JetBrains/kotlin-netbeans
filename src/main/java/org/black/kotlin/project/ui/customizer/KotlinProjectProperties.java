 ...
 * @author Petr Hrebejk
 */
public class KotlinProjectProperties {
    ...
    public KotlinProjectProperties( KotlinProject project, UpdateHelper updateHelper, PropertyEvaluator evaluator, ReferenceHelper refHelper, GeneratedFilesHelper genFileHelper ) {
    ...
    public void save() {
        try {
            if ((genFileHelper.getBuildScriptState(GeneratedFilesHelper.BUILD_IMPL_XML_PATH,KotlinProject.class.getResource("resources/build-impl.xsl")) //NOI18N
    ...
    private void storeProperties() throws IOException {
        ...
        PlatformUiSupport.storePlatform (projectProperties, updateHelper, "http://www.netbeans.org/ns/kotlin-project/1", PLATFORM_MODEL.getSelectedItem(), JAVAC_SOURCE_MODEL.getSelectedItem());
    ...
    boolean makeSharable() {
        ...
        String customTasksLibs = getProject().getPropertyEvaluator().getProperty(AntBuildExtender.ANT_CUSTOMTASKS_LIBS_PROPNAME);
