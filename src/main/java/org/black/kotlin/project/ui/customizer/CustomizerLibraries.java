...
public class CustomizerLibraries extends JPanel implements HelpCtx.Provider, ListDataListener {
    ...
    CustomizerLibraries( KotlinProjectProperties uiProps, KotlinCustomizerProvider.SubCategoryProvider subcat ) {
        ...
        testBroken();
        if (KotlinCompositePanelProvider.LIBRARIES.equals(subcat.getCategory())) {
    ...
    private void testBroken() {
        ...
        KotlinProjectLogicalView viewProvider = uiProperties.getProject().getLookup().lookup(KotlinProjectLogicalView.class);
        //Update the state of project's node if needed
        //TODO//viewProvider.testBroken();
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(librariesLocation, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 548, Short.MAX_VALUE)
                    .add(jComboBoxTarget, 0, 548, Short.MAX_VALUE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
