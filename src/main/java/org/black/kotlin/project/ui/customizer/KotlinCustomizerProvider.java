 ...
 * @author Petr Hrebejk
 */
public class KotlinCustomizerProvider implements CustomizerProvider {
    ...
    public void showCustomizer( String preselectedCategory, String preselectedSubCategory ) {
        ...
        if ( dialog != null ) {            
            ...
            KotlinProjectProperties uiProperties = new KotlinProjectProperties( (KotlinProject)project, updateHelper, evaluator, refHelper, genFileHelper );
