...
public class CustomizerSources extends javax.swing.JPanel implements HelpCtx.Provider {
    ...
    public CustomizerSources(KotlinProjectProperties uiProperties ) {
        ...
        KotlinSourceRootsUi.EditMediator emSR = KotlinSourceRootsUi.registerEditMediator(
        ...
        KotlinSourceRootsUi.EditMediator emTSR = KotlinSourceRootsUi.registerEditMediator(
            uiProperties.getProject(),
        ...
        enableSourceLevel ();
        this.originalEncoding = this.uiProperties.getProject().
                getPropertyEvaluator().getProperty(KotlinProjectProperties.SOURCE_ENCODING);
